...
class ConfirmDeleteReceitaModal extends ModalBase {
  constructor() {
    super();
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div id="modal" role="dialog" aria-labelledby="modal-title">
        <div class="modal-content">
          <h2 id="modal-title">Tem certeza que deseja excluir esta receita?</h2>
...
if (!customElements.get('confirm-delete-receita-modal')) {
  customElements.define('confirm-delete-receita-modal', ConfirmDeleteReceitaModal);
}

export default ConfirmDeleteReceitaModal;
